"""
============================================
Detect thủ công, bằng tâm mâm đến tâm của lỗ chấu
============================================
"""
import argparse
...
import get_chuck_angle_local_v3
...
if __name__ == "__main__":    
    ...
    if args.mode == "local":
        ...
        get_chuck_angle_local_v3.main_local(image_rectified, cfg, detect = args.detect, edge = args.edge, save = args.save, debug = args.debug)
